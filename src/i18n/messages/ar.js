...
export default {
    [LOCALES_TYPES.ARABIC]: {
        ...
        ORDER_DETAILS: {
            ...
            "MUST_INLCUDE_DP":"ℹ️ يجب أن يشمل سعر التوصيل",
            "WILL_SEND_SMS" : "ℹ️ سيتم إرسال رابط للدفع إلى رقم هاتف المستلم",
        ...
        HOME: {
            "MAIN_HEADER_TEXT": "هل لديك متجر الكتروني ، او ترغب في ايصال او استلام طرد ؟ ",
            ...
            "RETURN_POLICY_CONTENT" : "لا توفّر Togo خدمة التبديل أو الترجيع ضمن سياستها، ويُترك أي اتفاق بشأن الإرجاع أو الاستبدال للترتيب المباشر بين المرسل والمستلم دون تحمّل Togo أي مسؤولية."
        },
        ADMIN: {
