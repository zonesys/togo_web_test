...
import {
  admin_GetAllActiveFoodOrders,
  admin_GetAllFinishedFoodOrders,
  admin_GetAllDeletedFoodOrders,
  GetAllReturnedOrders,
  GetAllMarkedErrorOrders,
  admin_GetAllNewFoodOrders,
...
export default function FoodOrders() {
  ...
  useEffect(() => {
    ...
    // get all new orders
    admin_GetAllNewFoodOrders(newOrdersSearchStr, newOrdersFromToDate).then((res) => {
  ...
  useEffect(() => {
    ...
    admin_GetAllActiveFoodOrders(activeOrdersSearchStr, activeOrdersFromToDate).then((res) => {
  ...
  useEffect(() => {
    ...
    admin_GetAllFinishedFoodOrders(finishedOrdersSearchStr, finishedOrdersFromToDate).then((res) => {
      // console.log(res.data.orders_list)
  ...
  useEffect(() => {
    ...
    admin_GetAllDeletedFoodOrders(deletedOrdersSearchStr, deletedOrdersFromToDate).then((res) => {
