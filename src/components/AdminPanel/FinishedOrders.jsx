...
import { GetAllFinishedOrders } from "../../APIs/AdminPanelApis";
...
const OrdersColumn = ({ index, title, orders, ordersCount, loading, searchAndFilter, handleSelect, isErrs }) => {
    ...
    return (
        <div className="orders-column">
            <div className='header d-flex justify-content-center' style={{ marginLeft: index !== "first" ? "-8px" : "", marginRight: index !== "last" ? "-8px" : "" }}>
                <div>
