...
export default function Timeline(props) {
    ...
    // console.log(props.transporters);

    /* for (let i = 0; i < props.transporters.length; i++) {
        props.transportationParties.splice(1, 0, {
            type: 2,
            current: false,
            address: null,
            name: "test",
        ...
        <>
            ...
            {/*{console.log(window.innerWidth)}*/}
                {props.transportationParties.length !== 1 && props.transportationParties.map((user, index) => 
                    <div key={index} className={!isEn ? "arrow " + (index % 2 == 0 ? "step1" : "step2") :  "arrowEn " + (index % 2 == 0 ? "step1En" : "step2En")} onClick={() => {handleShow(); setUser(user)}}>
            ...
            <Modal show={show} onHide={handleClose} centered className="rounded-lg">
                ...
                <Modal.Body>
                    ...
                    {/*{user.address != null ? <Address address={user.address} name={user.name}/> : <p>Account Info goes here...</p>}*/}

                    <Address address={user.address != null && user.address} customerName={user.customerName} name={user.name} phone={user.phone} price={user.price} image={user.imageURL} pickupDate={user.pickupDate}/>
